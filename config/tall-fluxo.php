...
return [
    ...
    'views'=>[
        ...
        'validations'=>[
            ...
            "accepted_if"=>["label"=>"Accepted If","params"=>true,"visible"=>true, "help"=>"O campo em validação deve ser <b>yes, on, 1 ou true</b> se outro campo em validação for igual a um valor especificado. Isso é útil para validar a aceitação dos <b>Termos de Serviço</b> ou campos semelhantes."],
            "active_url"=>["label"=>"Active URL","params"=>true,"visible"=>true, "help"=>"O campo em validação deve ter um registro A ou AAAA válido de acordo com a dns_get_recordfunção PHP. O nome do host da URL fornecida é extraído usando a parse_urlfunção PHP antes de ser passado para dns_get_record."],
            "after"=>["label"=>"After (Date)","params"=>true,"visible"=>true, "help"=>"O campo em validação deve ser um valor após uma determinada data. As datas serão passadas para a strtotimefunção PHP para serem convertidas em uma DateTimeinstância válida:"],
            "after_or_equal"=>["label"=>"After Or Equal (Date)","params"=>true,"visible"=>true, "help"=>"O campo em validação deve ser um valor posterior ou igual à data indicada. Para obter mais informações, consulte a regra após ."],
            "alpha"=>["label"=>"Alpha","params"=>true,"visible"=>true, "help"=>"O campo em validação deve ser inteiramente de caracteres alfabéticos."],
            "alpha_dash"=>["label"=>"Alpha Dash","params"=>true,"visible"=>true, "help"=>"O campo em validação pode conter caracteres alfanuméricos, bem como hífens e sublinhados."],
            "alpha_num"=>["label"=>"Alpha Numeric","params"=>true,"visible"=>true, "help"=>"O campo em validação deve ser inteiramente de caracteres alfanuméricos."],
            "array"=>["label"=>"Array","params"=>true,"visible"=>true, "help"=>"O campo em validação deve ser um PHP array."],
            "bail"=>["label"=>"Bail","params"=>true,"visible"=>true, "help"=>"Pare de executar regras de validação para o campo após a primeira falha de validação."],
            "before"=>["label"=>"Before (Date)","params"=>true,"visible"=>true, "help"=>"O campo em validação deve ser um valor anterior à data especificada. "],
            "before_or_equal"=>["label"=>"Before Or Equal (Date)","params"=>true,"visible"=>true, "help"=>"O campo em validação deve ser um valor anterior ou igual à data indicada"],
            ...
            "date_equals"=>["label"=>"Date Equals","params"=>true,"visible"=>true, "help"=>"O campo em validação deve ser igual à data indicada. As datas serão passadas para a strtotimefunção PHP para serem convertidas em uma DateTimeinstância válida."],
            ...
            "declined_if"=>["label"=>"Declined If","params"=>true,"visible"=>true, "help"=>"O campo em validação deve ser no, off, 0ou falsese outro campo em validação for igual a um valor especificado."],
            "different"=>["label"=>"Different","params"=>true,"visible"=>true, "help"=>"O campo em validação deve ter um valor diferente do campo ."],
            ...
            "email"=>["label"=>"Email","params"=>true,"visible"=>true, "help"=>"O campo em validação deve ser formatado como um endereço de e-_mail."],
            ...
            "filled"=>["label"=>"Filled","params"=>true,"visible"=>true, "help"=>"O campo em validação não deve estar vazio quando presente."],
            ...
            "ip"=>["label"=>"IP Address","params"=>true,"visible"=>true, "help"=>"O campo em validação deve ser um endereço IP."],
            ...
            "mac"=>["label"=>"MAC Address","params"=>true,"visible"=>true, "help"=>"O campo em validação deve ser um endereço MAC."],
            ...
            "multiple_of"=>["label"=>"Multiple Of","params"=>true,"visible"=>true, "help"=>"O campo em validação deve ser um múltiplo de value ."],
            ...
            "nullable"=>["label"=>"Nullable","params"=>true,"visible"=>true, "help"=>"O campo em validação pode ser null."],
            "numeric"=>["label"=>"Numeric","params"=>true,"visible"=>true, "help"=>"O campo em validação deve ser numérico ."],
            "password"=>["label"=>"Password","params"=>true,"visible"=>true, "help"=>"O campo em validação deve corresponder à senha do usuário autenticado."],
            "present"=>["label"=>"Present","params"=>true,"visible"=>true, "help"=>"O campo em validação deve estar presente nos dados de entrada, mas pode estar vazio."],
            "prohibited"=>["label"=>"Prohibited","params"=>true,"visible"=>true, "help"=>"O campo em validação deve ser uma string vazia ou ausente."],
            "prohibited_if"=>["label"=>"Prohibited If","params"=>true,"visible"=>true, "help"=>"O campo em validação deve ser uma string vazia ou ausente se o campo otherfield for igual a qualquer valor ."],
            "prohibited_unless"=>["label"=>"Prohibited Unless","params"=>true,"visible"=>true, "help"=>"O campo em validação deve ser uma string vazia ou não estar presente, a menos que o campo otherfield seja igual a qualquer valor ."],
            "prohibits"=>["label"=>"Prohibits","params"=>true,"visible"=>true, "help"=>"Se o campo em validação estiver presente, nenhum campo de outro campo poderá estar presente, mesmo que esteja vazio."],
            ...
            "required"=>["label"=>"Required","params"=>true,"visible"=>true, "help"=>"O campo em validação deve estar presente nos dados de entrada e não vazio. O valor é null, O valor é uma string vazia, O valor é uma matriz vazia ou um Countableobjeto vazio ou O valor é um arquivo carregado sem caminho."],
